...
class AdminController extends Controller
{
    ...
    public function settings(){
        ...
        $data=Settings::where('branch_id',$user)->first();
        $countries=Country::all();
        $cities=City::all();
        $selected_country =$data->country_id;
         $selected_city =$data->city_id;
        return view('backend.setting', compact('data', 'countries', 'cities','selected_country','selected_city'));
    }
