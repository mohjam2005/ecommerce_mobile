...
Parsley.addMessages('fa', {
  ...
  type: {
    ...
    url:          "این مقدار باید یک العنوان معتبر باشد",
  ...
  pattern:        "این مقدار به نظر می رسد العميلعتبر است",
  ...
  length:         "این مقدار العميلعتبر است و باید بین %s و %s باشد",
  mincheck:       "شما حداقل باید %s گزینه را اختيار کنید.",
  maxcheck:       "شما حداکثر می‌توانید %s اختيار داشته باشید.",
  check:          "باید بین %s و %s مورد اختيار کنید",
