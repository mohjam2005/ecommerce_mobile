...
@section('title','فروشگاه اینترنتی || تعديل بنر')
@section('main-content')

<div class="card">
    <h5 class="card-header">تعديل بنر</h5>
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}" enctype ="multipart/form-data">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="عنوان  "  value="{{$banner->title}}" class="form-control">
        @error('title')
