...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">لیست القسم الرئيسي ‌های الموضوع</h6>
      <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="اضافة"><i class="fas fa-plus"></i>جديد الموضوع</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">هیچ القسم الرئيسي  الموضوعی یافت نشد!!! لطفاً القسم الرئيسي  الموضوع ایجاد کنید</h6>
        @endif
      </div>
    </div>
</div>
