...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        ...
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'index')) }}"><div data-tilt data-tilt-glare data-tilt-max-glare="0.8"><img
                src="{{ URL::asset('assets/img/brand/nagel.png') }}" alt="logo"></div></a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/img/brand/nagel.png') }}" class="main-logo dark-theme" alt="logo"></a>
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            @can('الامتحانات')
            <li class="side-item side-item-category">الامتحانات</li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الامتحانت</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">

                    @can('تصنيف الامتحانات')

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'exam_classes')) }}">تصنيف الامتحانات</a></li>

                    @endcan

                    @can('الاسئلة')

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'exam_question')) }}"> جميع الأسئلة</a></li>

                    @endcan

                    
                    @can('الطلاب الممتحنين')

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'exam_sessions')) }}">  الامتحانات المحجوزة  </a></li>
                        {{-- <li><a class="slide-item" href="{{ url('/' . ($page = 'exam_sessions/all')) }}"> جميع الطلاب الممتحنيين</a></li> --}}

                    @endcan
                    @can('مراجعة الطالب')

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'exam_questions')) }}"> مراجعة امتحان  </a></li>
                    {{-- <li><a class="slide-item" href="{{ url('/' . ($page = 'exam_sessions/all')) }}"> جميع الطلاب الممتحنيين</a></li> --}}

                @endcan

                    @can('اضافة طالب للاختبار')
                ...
                @can('تقارير الطلاب')
                <li><a class="slide-item" href="{{ url('/' . ($page = 'student_report')) }}">نتائج الطلاب</a>
                </li>
            @endcan
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    @can('قائمة الطلاب')
                        ...
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'students')) }}">قائمة الطلاب</a></li>
        ...
        @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقارير الطلاب')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'student_report')) }}">تقارير الطلاب</a>
                            </li>
                        @endcan
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('المدرسة')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'schools')) }}">المدارس</a></li>
                        @endcan

                        @can('انواع الاختبارات')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'exams_types')) }}">انواع الاختبارات</a></li>
                        @endcan

                        @can('المديريات')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'goverments')) }}">المديريات</a></li>
                        @endcan
