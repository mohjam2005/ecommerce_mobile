...
<html>
<head>
  <title>الطلب @if($order)- {{$order->order_number}} @endif</title>
...
<style type="text/css">
    ...
    <table class="table table-bordered table-stripe">
      <thead>
        <tr>
          ...
          <th scope="col" class="col-3">العدد</th>
      ...
      {{-- @if(!empty($order->coupon))
        <tr>
          <th scope="col" class="empty"></th>
          <th scope="col" class="text-right">نسبة التخفيض:</th>
      ...
      @endif --}}
        <tr>
          ...
          @endphp
          <th scope="col" class="text-right ">الكمية حمل و نقل:</th>
  ...
  <div class="clearfix"></div>
@else
  <h5 class="text-danger">العميلعتبر</h5>
@endif
</body>
</html>