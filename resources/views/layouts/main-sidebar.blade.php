...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        ...
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'home')) }}"><div data-tilt data-tilt-glare data-tilt-max-glare="0.8"><img
                src="{{ URL::asset('assets/img/brand/nagel.png') }}" style="max-height:40px" alt="logo"></div></a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'home')) }}"><img
                src="{{ URL::asset('assets/img/brand/nagel.png') }}" style="max-height:40px" class="main-logo dark-theme" alt="logo"></a>
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">تجارة الكترونية</li>
            <li class="slide">
            ...
            @can('الامتحانات')
            <li class="side-item side-item-category">الادمن</li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">ثوابت الادمن</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">

 
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'banner')) }}"> الاعلانات</a></li>


 
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'category')) }}">الاقسام</a></li>

 
                    
 
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'product')) }}">المنتجات </a></li>
                        {{-- <li><a class="slide-item" href="{{ url('/' . ($page = 'exam_sessions/all')) }}"> جميع الطلاب الممتحنيين</a></li> --}}

                   

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'order')) }}">الطلبات </a></li>

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'brand')) }}">البراندات </a></li>
                    ...
                    {{-- <li><a class="slide-item" href="{{ url('/' . ($page = 'exam_sessions/create')) }}"> اضافة طالب للاختبار</a></li> --}}
        ...
        @endcan
            ...
            @can('الطلاب')
            <li class="side-item side-item-category">المواضيع</li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                    </svg><span class="side-menu__label">المواضيع</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'post')) }}">المواضيع </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'post-category')) }}">الاقسام الرئيسية </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'post-tag')) }}">التاغ للمواضيع </a></li>
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">اعدادات الموقع</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                             <li><a class="slide-item" href="{{ url('/' . ($page = 'coupon')) }}"> الكوبونات</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'message')) }}"> رسائل الصفحة</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}"> المستخدمين</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'settings')) }}"> اعدادات الموقع</a>
                            </li>
            ...
            @can('المستخدمين')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('إضافة صلاحية')
                          <li><a class="slide-item" href="{{ url('/' . ($page = 'permissions')) }}">اضافة صلاحيات</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
