    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('/' . ($page = 'index')) }}">
                    ...
                    <img src="{{ URL::asset('assets/img/brand/nagel.png') }}"
        ...
        <div class="main-header-right">
                    ...
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                    src="{{ URL::asset('assets/img/flags/palestine-flag.png') }}" alt="img"></span>
                            <div class="my-auto">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                <div class="nav-link" id="bs-example-navbar-collapse-1" style="
                width: 163px;
                margin-top: 10px;
            ">
                    ...
                    <div id="notifications">
                        ...
                        @endforeach
                            ...
                            <a class="dropdown-item text-center small text-gray-500" href="{{route('all.notification')}}">جميع الاشعارات</a>
                          </div>
                    </div>
                    {{-- تحرير 2 وشفوي 1 --}} 
                    {{-- <input type="radio" id="choice1" name="choice" value="2" {{ session('session_type') == 2 ? 'checked' : '' }}>
                    <label for="choice1"><i class="fas fa-light fa-copy"> تحريري</i></label>
                    @php
                        
 
                    @endphp
                     <input type="radio" id="choice2" name="choice" value="1" {{ session('session_type') == 1 ? 'checked' : '' }}>
                    <label for="choice2"><i class="fas fa-solid fa-headphones"> شفوي</i></label> --}}
                </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('index.changpassword') }}"><i class="bx bx-cog"></i> تغيير كلمة المرور</a>
