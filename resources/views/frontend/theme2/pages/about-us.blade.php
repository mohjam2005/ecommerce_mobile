			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service" style="text-align: center; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
						...
						<p style="color: #6c757d;">الطلبات بالای 100 دلار</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
				...
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service" style="text-align: center; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
						...
						<h4 style="color: #61bec3; margin-top: 10px;">الدفع امن</h4>
						<p style="color: #6c757d;">100% الدفع امن</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service" style="text-align: center; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
						...
						<h4 style="color: #61bec3; margin-top: 10px;">بهترین القيمة</h4>
						<p style="color: #6c757d;">القيمة تضمینی</p>
					</div>
					<!-- End Single Service -->
				</div>
			</div>
