        ...
        <div class="row">
            ...
            <aside class="sidebar-page col-12 col-sm-12 col-md-4 col-lg-3">
                <form action="{{route('shop.filter')}}" method="POST">
                    ...
                    <div class="box">
                        <header class="card-header">
                            <h3 class="card-title"><span class="space-right-10">القيمة</span></h3>
                        </header>
                        <div class="box-content space-40 space-right-25 space-left-25">
                            <div class="product_filter">
                                <div class="label-input">
                                    <span> رنج القيمة </span>
                                    <div>
                    ...
                    <div class="box">
                        <header class="card-header">
                            <h3 class="card-title"><span class="space-right-10">البراندها</span></h3>
                        </header>
                        <div class="box-content">
                            <ul class="categor-list">
                                @php
                    ...
                    <div class="box">
                        <header class="card-header">
                            <h3 class="card-title"><span class="space-right-10">الموضوع‌های انعم</span></h3>
                        </header>
                        <div class="box-content">
                ...
                <div class="listing default">
                    <div class="listing-header default marg_all0">
                        <ul class="Search_list nav nav-tabs" role="tablist">
                            ...
                            <li><a data-toggle="tab" href="#price" role="tab" aria-expanded="false">‌براساس القيمة</a></li>
                        </ul>
                    </div>
                                        ...
                                        <div class="product-box">
                                            ...
                                            <div class="product-box-content">
                                                ...
                                                <div class="product-box-row product_price_search">
                                                    <div class="price">
                                                        @if($product->discount)
                                                            <del><span>{{ number_format($product->price) }}<span>$</span></span></del>
                                                            <span class="discount_badge">{{ $product->discount }}%</span>
                                                            <ins><span>{{ number_format($product->price - ($product->price * $product->discount / 100)) }}<span>$</span></span></ins>
                                                        @else
                                                            <ins><span>{{ number_format($product->price) }}<span>$</span></span></ins>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
...
<style>
    ...
    /* تنظیم الحجم فونت و سایر ویژگی‌های فلش‌های pagination */
    .pagination .page-link {
        font-size: 14px; /* تنظیم الحجم فونت فلش‌ها */
    ...
    /* تنظیم الحجم فونت برای آیکون‌های خاص */
