        ...
        <div class="container">
            <div class="row">
                <aside class="sidebar-page col-12 col-sm-12 col-md-4 col-lg-3">
                                    ...
                                    <div class="label-input">
                                        <ul class="categor-list">
                                            @if (!empty($_GET['category']))
                                                ...
                                                @endphp
                                            @endif
                                            @foreach (App\Http\Controllers\ShippingController::postCategoryList('posts') as $cat)
                                                <li>
                    ...
                    <div class="box">
                        <header class="card-header">
                            <h3 class="card-title"><span class="space-right-10">مقالات انعم</span></h3>
                        </header>
                        <div class="box-content">
                            ...
                            <div class="single-widget side-tags">
                                <ul class="tag">
                                    @if (!empty($_GET['tag']))
                                        ...
                                        @endphp
                                    @endif
                                    @foreach (App\Http\Controllers\ShippingController::postTagList('posts') as $tag)
                                        <li>
                        ...
                        <div class="blog-single-main">
                            ...
                            @else
                                <div class="col-12 mt-4">
                                    <div class="reply">
                                        <div class="reply-head comment-form" id="commentFormContainer">
                                            <h2 class="reply-title">کامنت بزارید</h2>
                                            <p class="text-center">برای گذاشتن کامنت لطفا <a href="{{ route('login.form') }}">ثبت العميل</a> کنید یا <a href="{{ route('login.form') }}">وارد شوید</a>.</p>
                                            <!-- Comment Form -->
                                            <form class="form comment_form" id="commentForm"
                                                action="{{ route('post-comment.store', $post->slug) }}" method="POST">
                                                @csrf
                            ...
                            <div class="col-12">
                                <div class="comments unique-comments-section" style="width: 100%;">
                                    <h3 class="custom-comment-title">العدد کامنت ها  ({{ $post->allComments->count() }})</h3>
                                    <!-- Single Comment -->
