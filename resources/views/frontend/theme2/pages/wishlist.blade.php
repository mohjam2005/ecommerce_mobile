					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">اضافة  به سبد</th> 
								<th class="text-center"><i class="ti-trash remove-icon"></i></th>
							</tr>
						</thead>
						<tbody>
							@if(App\Http\Controllers\ShippingController::getAllProductFromWishlist())
								@foreach(App\Http\Controllers\ShippingController::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										@php 
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>اضافة  به سبد</a></td>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="quickview-content">
                                ...
                                <div class="quickview-peragraph">
                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی العميلفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                                </div>
								<div class="size">
									<div class="row">
								...
								<div class="add-to-cart">
									<a href="#" class="btn">اضافة  به سبد</a>
