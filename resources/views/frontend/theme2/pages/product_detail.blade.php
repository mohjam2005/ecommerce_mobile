                                        ...
                                        <div class="modal-footer">
                                            <form class="default">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <p>
                                                            برای کپی العنوان در کادر زیر دابل کلیک کنید
                                                        </p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6 col-md-6 border_left">
                                                <div class="price space-15">
                                                    ...
                                                    @endphp
                                                    <del><span>{{ number_format($product_detail->price, 2) }} <span>$</span></span></del>
                                                    <ins><span>{{ number_format($after_discount, 2) }} <span>$</span></span></ins>
                                                </div>
                                                <div class="col-12 timer-title text--center">
                                                    <form action="{{route('single-add-to-cart')}}" method="POST">
                                                        ...
                                                        <div class="add-to-cart mt-4">
                                                            <button href="{{route('add-to-wishlist',$product_detail->slug)}}"  type="submit" class="btn">اضافة  به سبد خرید</button>
                                                         </div>
                                                    </form>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body default">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="comments" role="tabpanel" aria-expanded="false">
                                        <header class="card-header">
                                            <h3 class="card-title"><span>دیدگاه های دیگر مستخدمان</span></h3>
                                        </header>
