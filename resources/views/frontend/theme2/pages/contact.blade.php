						...
						<div class="col-lg-8 col-12">
							<div class="form-main contact-form-main">
								<div class="title contact-title">
									...
									<h3>الرسالة خود را برای ما بنویسید @auth @else<span style="font-size:12px;" class="text-danger">[ابتدا باید وارد شوید]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group contact-form-group">
												<label>العميل شما<span>*</span></label>
												<input name="name" id="name" type="text" placeholder="العميل خود  ">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group contact-form-group">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group contact-form-group">
												...
												<input name="email" type="email" id="email" placeholder="ایمیل خود  ">
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group contact-form-group">
												<label>التلفونشما<span>*</span></label>
												<input id="phone" name="phone" type="number" placeholder="التلفونخود  ">
											</div>	
										</div>
										<div class="col-12">
											<div class="form-group contact-form-group message">
												<label>الرسالة شما<span>*</span></label>
												<textarea name="message" id="message" cols="30" rows="9" placeholder="الرسالة خود  "></textarea>
											</div>
										</div>
										<div class="col-12">
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-success">الرسالة شما با موفقیت ارسال شد...</p>
			</div>
		  </div>
		</div>
	</div>
