            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-12">
                    ...
                    <div class="inner text-center" style="background-color: #61bec3; padding: 30px; border-radius: 10px;">
                        <h4 style="color: #fff;">خبرالعميله</h4>
                        <p style="color: #fff;">عضویت در خبرالعميله و دریافت <span style="color: #ffc107;">10%</span> نسبة التخفيض برای اولین خرید</p>
                        <form action="{{route('subscribe')}}" method="post" class="newsletter-inner" style="display: flex; flex-direction: column; align-items: center;">
                            @csrf
                            <input name="email" placeholder="العنوان ایمیل شما" required="" type="email" style="padding: 10px; border: 1px solid #6c757d; border-radius: 5px; margin-bottom: 10px; width: 100%; max-width: 400px;">
