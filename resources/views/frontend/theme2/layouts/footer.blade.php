<footer class="main-footer default">
        ...
        <div class="footer-services container  space-10">
            <div class="row">
                <div class="service-item col-2 contact-box text-center">
                    <img src="{{ asset('frontend/theme1/assets/img/ico/png-4.png') }}" class="width-40" />
                    <span class="title-1 light-black">ضمانت اصل بودن</span>
                </div>
                <div class="service-item col-2 contact-box text-center">
                    <img src="{{ asset('frontend/theme1/assets/img/ico/png-1.png') }}" class="width-40" />
                    <span class="title-1 light-black">الدفع در محل</span>
                </div>
                <div class="service-item col-2 contact-box text-center">
                    <img src="{{ asset('frontend/theme1/assets/img/ico/png-2.png') }}" class="width-40" />
                    <span class="title-1 light-black">ارسال سریع</span>
                </div>
                <div class="service-item col-2 contact-box text-center">
                    <img src="{{ asset('frontend/theme1/assets/img/ico/png-5.png') }}" class="width-40" />
                    <span class="title-1 light-black">فرصت 7 روزه استرداد</span>
                </div>
                <div class="service-item col-2 contact-box text-center">
                    <img src="{{ asset('frontend/theme1/assets/img/ico/png-3.png') }}" class="width-40" />
                    <span class="title-1 light-black">پشتیبانی تلفنی</span>
                </div>
                <div class="service-item col-2 contact-box text-center">
                    <img src="{{ asset('frontend/theme1/assets/img/ico/png-7.png') }}" class="width-40" />
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="widget-menu widget card">
                        ...
                        <div class="License_img">
                            ...
                            <a href="#" target="_blank"><img
                                    src="{{ asset('frontend/theme1/assets/img/License_1.png') }}" alt=""></a>
                        </div>
                    </div>
    ...
    <div class="copyright">
        <div class="container">
            <p>
                این قالب به وسیله گروه برالعميله نویسی گرزک پشتیبانی میشود.
            </p>
        </div>
    </div>
</footer>
...
<script src="{{ asset('frontend/theme1/assets/js/plugins/jquery.sharrre.js') }}" type="text/javascript"></script>
