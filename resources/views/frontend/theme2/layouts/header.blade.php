    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
            ...
            <ul class="navbar-nav default">
                @php
                    $categories = App\Http\Controllers\ShippingController::getAllCategory();
                @endphp
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbar_a">
                            ...
                            <div class="m_cart-header">
                                <div class="m_cart-total">
                                    <span>مجموع سبد:</span>
                                    <span>{{ number_format(App\Http\Controllers\ShippingController::totalCartPrice(), 2) }}</span>
                                    <span> $</span>
                                </div>
                            </div>
                            <div class="btn_cart">
                                <a href="{{ route('cart') }}" class="btn btn_sabad">مشاهده سبد</a>
                                <a href="{{ route('checkout') }}" class="btn btn_pardakht btn-main-masai">الدفع</a>
                            </div>
                        </div>
                    </div>
                </div>
